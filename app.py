...
<body>
    ...
    <div class="nav">
        ...
        <div class="nav-right" style="display:flex; align-items:center; gap:15px;">
            <div class="desktop-menu">
                <a href="https://typing.snapzopro.online" target="_blank" class="menu-btn typing-link">
    ...
    <div class="main">
        ...
        <div class="tool-wrapper active" id="tool-promo" style="width: 100%; max-width: 1100px; justify-content: center; margin-bottom: 20px;">
            <div class="card" style="width: 100%; max-width: 100%; background: #fffbeb; border: 2px solid #fcd34d; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 20px; padding: 20px;">
                <div style="display: flex; align-items: center; gap: 20px;">
                    <i class="fas fa-keyboard" style="font-size: 3rem; color: #d97706;"></i>
                    <div>
                        <h2 style="margin: 0; color: #92400e; font-size: 1.5rem;">Hindi Typing Studio</h2>
                        <p style="margin: 5px 0 0 0; color: #b45309;">Kruti Dev, Unicode Converter aur English-to-Hindi typing ek hi jagah.</p>
                    </div>
                </div>
                <a href="https://typing.snapzopro.online" target="_blank" class="btn" style="width: auto; margin-top: 0; background: #d97706; padding: 12px 25px;">Typing Shuru Karein</a>
            </div>
        </div>
    ...
    <script>
        ...
        function switchTool(name, event, autoFormat = null) {
            ...
            // 🟡 Show promo ONLY on passport maker page 🟡
            const promo = document.getElementById('tool-promo');
            if(promo) {
                if (name === 'passport') promo.style.display = 'flex';
    ...
    if request.method == 'POST':
        try:
            ...
            if tool_type == 'idcard':
                ...
                c.drawImage(ImageReader(io.BytesIO(buf_f)), 150,
